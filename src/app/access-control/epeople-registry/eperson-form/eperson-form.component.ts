...
export class EPersonFormComponent implements OnInit, OnDestroy {
  ...
  organization: DynamicInputModel;
  country: DynamicInputModel;
  ...
  initialisePage() {
    ...
    observableCombineLatest([
      ...
      this.translateService.get(`organization`),
      this.translateService.get(`country`),
      this.translateService.get(`${this.messagePrefix}.canLogIn`),
      this.translateService.get(`${this.messagePrefix}.requireCertificate`),
      this.translateService.get(`${this.messagePrefix}.emailHint`),
    ]).subscribe(([firstName, lastName, email,password,organization,country, canLogIn, requireCertificate, emailHint]) => {
      ...
      this.organization = new DynamicInputModel({
        id: 'organization',
        label: organization,
        name: 'organization',
      });
      this.country = new DynamicInputModel({
        id: 'country',
        label: country,
        name: 'country',
      });
      ...
      this.subs.push(this.epersonService.getActiveEPerson().subscribe((eperson: EPerson) => {
        ...
        this.formGroup.patchValue({
          ...
          organization: eperson != null ? eperson.firstMetadataValue('eperson.organization') : '',
          country: eperson != null ? eperson.firstMetadataValue('eperson.country') : '',
  ...
  editEPerson(ePerson: EPerson, values) {
    const editedEperson = Object.assign(new EPerson(), {
      ...
      metadata: {
        ...
        'eperson.organization': [
          {
            value: (this.organization.value ? this.organization.value : ePerson.firstMetadataValue('eperson.organization'))
          },
        ],
        'eperson.country': [
          {
            value: (this.country.value ? this.country.value : ePerson.firstMetadataValue('eperson.country'))
          },
        ],
      },
