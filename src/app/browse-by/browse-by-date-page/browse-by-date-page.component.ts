...
export class BrowseByDatePageComponent extends BrowseByMetadataPageComponent {
  ...
  public constructor(protected route: ActivatedRoute,
    ...
    super(route, browseService, dsoService, paginationService, router, appConfig, dsoNameService,windowService,auth);
  }
  ...
  ngOnInit(): void {
    ...
    this.subs.push(
      ...
      map(([loggedIn, isXsOrSm]) => {
          console.log("loggedIn && isXsOrSm1", loggedIn, !isXsOrSm);
          return (loggedIn && !isXsOrSm)
        } 
      ) 
    );
  }
