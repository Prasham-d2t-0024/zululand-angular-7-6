        ...
        children: [
          ...
          },
          {
          ...
          },
           {
            ...
            data: { title: 'Audit Report', breadcrumbKey: 'AuditReport' },
          ...
          },
          {
            ...
            data: { title: 'Productivity Report', breadcrumbKey: 'productivityReport' },
            canActivate: [AuthenticatedGuard, EndUserAgreementCurrentUserGuard]
          },
          {
            path: 'askus', resolve: {
              breadcrumb: I18nBreadcrumbResolver,
            }, loadChildren: () => import('./askus/askus.module').then(m => m.AskusModule),
            data: { title: 'Ask Us', breadcrumbKey: 'askus' },
            canActivate: [EndUserAgreementCurrentUserGuard]
          },
          {
            path: 'contactus', resolve: {
              breadcrumb: I18nBreadcrumbResolver,
            }, loadChildren: () => import('./contactus/contactus.module').then(m => m.ContactusModule),
            data: { title: 'Contact Us', breadcrumbKey: 'ContactUs' },
          },

          {
            path: 'aboutus', resolve: {
              breadcrumb: I18nBreadcrumbResolver,
            }, loadChildren: () => import('./aboutus/aboutus.module').then(m => m.AboutusModule),
            data: { title: 'About Us', breadcrumbKey: 'aaboutus' },
            canActivate: [EndUserAgreementCurrentUserGuard]
          },
          {
            path: 'faq', resolve: {
            ...
            data: { title: 'FAQ ', breadcrumbKey: 'FAQ' },
            canActivate: [EndUserAgreementCurrentUserGuard]
          },
          {
            path: 'ecds-partners', resolve: {
              breadcrumb: I18nBreadcrumbResolver,
            }, loadChildren: () => import('./ecds-partners/ecds-partners.module').then(m => m.EcdsPartnersModule),
            data: { title: 'ECDS-partner ', breadcrumbKey: 'ecds-partner' },
            canActivate: [EndUserAgreementCurrentUserGuard]
          },
          {
            path: 'community-list',
