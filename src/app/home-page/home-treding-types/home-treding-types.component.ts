...
export class HomeTredingTypesComponent implements OnInit {
  ...
  buttonClick(i) {
   ...
   downloadExcel() {
    const URL = this.collectionorCommunityId ? '/report/downloadTrandingMatricxtype?dateType=' + this.i+`&collectionorcommunityid=${this.collectionorCommunityId}`+ '&type='+this.type : '/report/downloadTrandingMatricxtype?dateType=' + this.i
