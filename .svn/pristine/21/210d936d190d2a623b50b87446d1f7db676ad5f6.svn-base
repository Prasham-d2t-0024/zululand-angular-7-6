...
export class CollectionDataService extends ComColDataService<Collection> {
  ...
  getAuthorizedCollectionwithCommunity(query: string, options: FindListOptions = {}, useCachedVersionIfAvailable = true, reRequestOnStale = true, ...linksToFollow: FollowLinkConfig<Collection>[]): Observable<RemoteData<PaginatedList<Collection>>> {
    const searchHref = 'findByCommunityByTitle';
    options = Object.assign({}, options, {
      searchParams: [new RequestParam('title', query)]
    });
